...
void main() {
  ...
  test('Live DUT and RF Pipeline Test on Connected Hardware', () async {
    final monitor = AdbMonitor();
    
    // Wait up to 10s for monitor loop to load DUT and run RF check
    for (int i = 0; i < 20; i++) {
      await Future.delayed(const Duration(milliseconds: 500));
      if (monitor.deviceConnected && !monitor.isRfTesting && monitor.info['PowerG'] != 'Đang kiểm tra...') {
        break;
      }
    }
